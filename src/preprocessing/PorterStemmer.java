...
public class PorterStemmer {
    ...
    public String step2(String word){
        if (measure(word) > 0) {
            ...
            if (word.endsWith("enci")) return word.substring(0, word.length() - 4) + "ence";
            if (word.endsWith("anci")) return word.substring(0, word.length() - 4) + "ance";
            if (word.endsWith("izer")) return word.substring(0, word.length() - 4) + "ize";
            if (word.endsWith("abli")) return word.substring(0, word.length() - 4) + "able";
            if (word.endsWith("alli")) return word.substring(0, word.length() - 4) + "al";
            if (word.endsWith("entli")) return word.substring(0, word.length() - 5) + "ent";
            if (word.endsWith("eli")) return word.substring(0, word.length() - 3) + "e";
            if (word.endsWith("ousli")) return word.substring(0, word.length() - 5) + "ous";
            ...
            if (word.endsWith("alism")) return word.substring(0, word.length() - 5) + "al";
            if (word.endsWith("iveness")) return word.substring(0, word.length() - 7) + "ive";
            if (word.endsWith("fulness")) return word.substring(0, word.length() - 7) + "ful";
            if (word.endsWith("ousness")) return word.substring(0, word.length() - 7) + "ous";
            if (word.endsWith("aliti")) return word.substring(0, word.length() - 5) + "al";
            if (word.endsWith("iviti")) return word.substring(0, word.length() - 5) + "ive";
            if (word.endsWith("biliti")) return word.substring(0, word.length() - 6) + "ble";
        }
        return word;
    }
    public String step3(String word) {
        if (measure(word) > 0) {
            ...
            if (word.endsWith("iciti")) return word.substring(0, word.length() - 5) + "ic";
            if (word.endsWith("ical")) return word.substring(0, word.length() - 4) + "ic";
    ...
    public String step4(String word) {
        if (measure(word) > 1) {
            ...
            if (word.endsWith("ic")) return word.substring(0, word.length() - 2);
            if (word.endsWith("able")) return word.substring(0, word.length() - 4);
            if (word.endsWith("ible")) return word.substring(0, word.length() - 4);
            if (word.endsWith("ant")) return word.substring(0, word.length() - 3);
            if (word.endsWith("ement")) return word.substring(0, word.length() - 5);
            if (word.endsWith("ment")) return word.substring(0, word.length() - 4);
            if (word.endsWith("ent")) return word.substring(0, word.length() - 3);
            if (word.endsWith("ou")) return word.substring(0, word.length() - 2);
        }
        return word;
    }
    public String step5(String word) {
        if (word.endsWith("e")) {
            ...
            if (measure(word.substring(0, word.length() - 1)) == 1 && !endsWithCVC(word.substring(0, word.length() - 1))) {
                return word.substring(0, word.length() - 1);
            }
        }
